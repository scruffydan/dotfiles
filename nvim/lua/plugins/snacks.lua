return {
  ...
  keys = {
    ...
    { "<leader>lD", function() Snacks.picker.diagnostics_buffer() end, desc = "Diagnostics (buffer)" },
    { "<leader>lW", function() Snacks.picker.diagnostics() end, desc = "Diagnostics (workspace)" },
    ...
    { "<leader>fs", function() Snacks.picker.treesitter() end, desc = "Treesitter symbols" },
